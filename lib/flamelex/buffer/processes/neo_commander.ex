# defmodule Flamelex.Buffer.NeoCommander do
#   @moduledoc """
#   This process is responsible for managing the state of the CommandBuffer.

#   The CommandBuffer is special - other buffers hold & manipulate data,
