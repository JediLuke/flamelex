...
#TODO 3 layers, of layered down squares - need to be able to hide/dhow them, and change the color of the middle one or translate it or something - it should stay on top of the one below it, and below the one above it
        ...
        # |> draw_layer(%{num: 2, id: :work_layer,  draw_function: test_draw(:yellow)})
        # # |> draw_layer(%{num: 3, id: :overlay,     draw_function: test_draw(:yellow)})
        # # |> draw_layer(%{num: 4, id: :menu_bar,    draw_function: test_draw(:yellow)})
        # # |> draw_layer(%{num: 5, id: :alerts_and_notifications,  draw_function: test_draw(:yellow)})
        # # |> draw_layer(%{num: 6, id: :kommander,   draw_function: test_draw(:yellow)})
