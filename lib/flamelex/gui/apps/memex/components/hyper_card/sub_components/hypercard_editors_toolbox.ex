# defmodule Flamelex.GUI.Component.Memex.HyperCard.EditorsToolBox do
...
#                 scene.assigns.tidbit.title |> String.to_atom()
#                 |> GenServer.cast(:exit_edit_mode)
